<?php include_once('header.php') ; ?>    
    <div class="content-wrap ">
        <div class="pt-90 pb-90 shape-parent main_bg_background">
            <!-- Shape-->
            ...
            <div class="container">
                <div class="row gy-70">
                    ...
                    <div class="col-lg-7 col-12">
                        <h1 class="mt-65 mb-5 background_heading">World Class Products.</h1>
                        <h1 class="background_heading" >
			                <div id="js-rotating">
			                	Excellent Distribution.,  Global Network.
			                </div>
			                  
			                </h1>
                       <!-- Button--><a class="btn btn-accent-1" href="about-us.php" >Learn More </a>
                    </div>
                </div>
            </div>
        </div>
        <div class="pt-50 pt-lg-50 pb-130">
            <div class="container">
                <div class="row mb-90">
                    <div class="col-lg-12 text-left">
                        <h2 class="m-0 product_section_heading" data-show="startbox" data-show-delay="100">We Offer a Wide Range of products <br>and commodities</h2>
                    </div>
                </div>
                <div class="row gy-30">
                    <div class="col-12 col-md-12 col-lg-12" data-show="startbox">
						...
						<div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
						  ...
						  <?php 
						    ...
						    <div class="carousel-item <?php if($list == 1){ echo 'active'; } ?>">
						    	<div class="can_image_section">
						      			<?php while($D = mysqli_fetch_assoc($R)){ ?>
							            <img src="<?php echo $D["PrimaryImage"] ; ?>"  alt="" />
							            <?php } ?>
						      		</div>
						      <div class="bacground_image_box" style="background: url(<?php echo $Data['BackgroundImage'] ; ?>);">
						      	<div class="row">
						      		<div class="col-md-5">
						      			<div class="box_content"></div>
						      			<div class="box_new_conetnt">
						                <h2 class="font-semibold md:text-2xl md:font-bold font-xxl text-white">
						                 <?php echo $Data["Name"] ; ?>               </h2>
						                <p class="p-3 text-white">
						                <?php echo substr($Data["Description"], 0, 150) ; ?>.                 </p>
						                <div class="mt-5">
						                  <a href="products.php?CategoryId=<?php echo $CatId ; ?>" class="btn btn-accent-1">Learn More</a>
						                </div>
						              </div>
						      		</div>
        ...
        <div class="absolute bottom-96 -right-52 z-50 hidden h-[500px] w-[500px]  rounded-full bg-red-500 object-cover md:block services_background_image" style="background-image: url(images/worldrounded.png)"></div>
        <div class="service_background">
                ...
                <div class="row gy-50">
                	<div class="col-lg-6 text-center offset-lg-1">
                        <div class="position-relative shape-parent">
                            ...
                            <div class="" style="--img-height: 70%;" data-show="startbox"><a class="image-link" href="assets/img/service_main_page.png"><img class="rounded-4" loading="lazy" src="assets/img/service_main_page.png" alt="" class="img-fluid"></a></div>
                        </div>
                    </div>
                    <div class="col-lg-5 mt-120">
                        <h3 class="mb-45" data-show="startbox">Our Services</h3>
            ...
            We are a global partner poised to deliver local market needs in the different regions we operate. The core of our business is modern trade distribution, export services and supermarket chain OEM services.
                        ...
                        <div data-show="startbox" data-show-delay="200">
                            <!-- Button--><a class="btn btn-accent-1" href="services.php" >Learn more</a>
                        </div>
                    </div>
        ...
        <div class="container pt-60 pb-60 message_ceo">
                <div class="row gy-50">
                	<div class="col-lg-7 offset-lg-1 mt-120">
                        <h3 class="mb-45" data-show="startbox">Message from Us</h3>
                        <p class="mb-40 width-80" data-show="startbox" data-show-delay="100">
            ...
            At Rohstoff Handel, we understand the importance of good food and how it forms a major part of promoting cultures and traditions. That is why we are committed to providing the best sustainable products that will continue to stand the test of time. We do not compromise on taste!
                        ...
                        <div data-show="startbox" data-show-delay="200">
                            <!-- Button--><a class="btn btn-accent-1" href="contact-us.php" >Learn more</a>
                        </div>
                    </div>
                	<div class="col-lg-4 text-center">
                        <div class="position-relative shape-parent">
                            <!-- Shape-->
                            <img class="rounded-full img-fluid" loading="lazy" src="images/hands.png" alt="" class="img-fluid">
                        </div>
                    </div>
                    
                    
                </div>
                <img src="images/sundi.png" class="absolute -bottom-20 -left-5 md:-bottom-5 md:left-16 message_ceo_icon" alt="">
            </div>
        
        <div class="pt-70 pb-70 recipe_section">
            <div class="container">
                <div class="row mb-40">
                    <div class="col-lg-6 offset-lg-3 text-center">
                        <h2 class="m-0 px-lg-70" data-show="startbox" data-show-delay="100">Recipe Hub</h2>
                    </div>
                </div><!-- Slider-->
                <div class="row">
                   
                        <?php
				          $Query = "SELECT * FROM recipes ORDER BY RAND() LIMIT 4 ";
				          $Result = mysqli_query( $Connection, $Query);
            			...
            			<div class="col-md-3 col-6">
            				<a href="recipe-details.php?RecipeId=102" class="text-decoration">
					             <div class="w-full rounded-32 bg-white p-2 md:min-w-[300px] recipe-list">
					             <div>
					               <img src="<?php echo $Data["PrimaryImage"] ; ?>" class=" w-full max-w-full h-full max-h-250p rounded-3xl object-cover md:h-[230px] min_height_mobile img-fluid" alt="">
					             </div>
					             <div class="p-3">
					               <h2 class="text-center font-semibold md:text-2xl md:font-bold recipe-heading"><?php echo $Data["Name"] ; ?></h2>
                 ...
                 <div class="row">
                 	<div class="col-md-12 text-center mt-40">
                 		<a class="btn btn-accent-1" href="recipes.php" >View all Recipes</a>
                 	</div>
                 </div>
            </div>
        </div>
